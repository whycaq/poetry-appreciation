<template>
  <div class="auth-container">
    <div v-if="!user" class="auth-buttons">
      <button @click="showLogin = true" class="auth-button login-button">
        登录
      </button>
      <button @click="showSignup = true" class="auth-button signup-button">
        注册
      </button>
    </div>
...
import { getCurrentUser, signIn, signUp, signOut, type User } from '../api/user'
